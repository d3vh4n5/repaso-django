...
SECRET_KEY = 'django-insecure-*fua@6*u*g!i128^qcq5ow6j+ly+n#wb7q=tq9azu%63$+w@3o'
...
INSTALLED_APPS = [
    #'django.contrib.admin', # Utiliza autodiscover para obtener el admin de todas las aplicaciones en "INSTALLED_APPS"
